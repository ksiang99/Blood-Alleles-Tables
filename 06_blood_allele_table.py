...
df_final.to_excel('Blood Allele Table.xlsx', index=False)
df_final.to_csv('Blood Allele Table.tsv', sep='\t', index=False)
...
df_final.to_excel('Blood Allele Table (Separated).xlsx', index=False)
df_final.to_csv('Blood Allele Table (Separated).tsv', sep='\t', index=False)
